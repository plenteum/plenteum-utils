...
const Self = function () {
  ...
  if (!this.crypto && typeof window !== 'undefined' && typeof window.PlenteumCrypto !== 'undefined') {
...
function loadNativeJS () {
  ...
  try {
    Self = require('./plenteum-crypto.js')()
    if (Object.getOwnPropertyNames(Self).length === 0) {
      throw new Error('Could not load')
    }
  } catch (e) {
